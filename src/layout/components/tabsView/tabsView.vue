...
export default {
  ...
  methods: {
    ...
    refreshSelectedTag(view) {
      this.$store.dispatch('tabsView/delCachedView', view).then(() => {
        const { fullPath } = view
        this.$nextTick(() => {
          this.$router.replace({
    ...
    closeSelectedTag(view) {
      this.$store.dispatch('tabsView/delView', view).then(({ visitedViews }) => {
    ...
    closeOthersTags() {
      ...
      this.$store.dispatch('tabsView/delOthersViews', this.selectedTag).then(() => {
        this.moveToCurrentTag()
      })
    },
    closeAllTags(view) {
