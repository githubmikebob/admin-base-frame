<template>
  <div>
    <div class="tool-bar">
      ...
      <search-input ref="searchInput" :keyword.sync="keyword.keyword.value" @search="search" placeholder="site" width="30%" />
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'sites.type', prop: 'type', width: '60', type: 'text', language: 'sites.types' },
        { name: 'sites.name', prop: 'name', width: '120', type: 'text' },
        { name: 'sites.host', prop: 'host', width: '170', type: 'text' },
        { name: 'sites.site', prop: 'site', width: '220', type: 'text' },
        // { name: 'sites.branch', prop: 'branch',width: '90', type: 'text'},
        { name: 'sites.updated_at', prop: 'updated_at', width: '140', type: 'text' },
        ...
        { name: 'item.status', prop: 'status', type: 'status', fixed: 'right' },
        {
          type: 'action', width: '110', buttons: [
            ...
            { name: 'button.deploy', prop: '', type: 'primary', event: 'deploy' }
          ]
        }
      ]
    }
