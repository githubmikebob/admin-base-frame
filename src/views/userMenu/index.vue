  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'menu.name', prop: 'title', width: '120', type: 'text' },
        { name: 'menu.nameEn', prop: 'name', width: '140', type: 'text' },
        { name: 'menu.parent', prop: 'menu.title', width: '140', type: 'text' },
        { name: 'menu.created_at', prop: 'created_at', width: '160', type: 'text' },
