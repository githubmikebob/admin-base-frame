<template>
  <div>
    <div class="tool-bar">
      ...
      <search-input ref="searchInput" :keyword.sync="keyword.keyword.value" @search="search" placeholder="carType"
                    width="30%"/>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'carType.name', prop: 'name', width: '', type: 'text' },
