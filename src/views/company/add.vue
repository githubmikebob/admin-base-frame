        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="$t('item.mobile')" prop="contact_mobile">
              <el-input :disabled="requesting" v-model="form.contact_mobile" :placeholder="$t('item.placeholder.mobile')" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item :label="$t('item.district')" prop="district" size="small">
        <select-district width="100%" margin_left="0" ref="selectDistrict" :disabled="requesting" @choose="chooseDistrict" />
      </el-form-item>
