<template>
  <div>
    <div class="tool-bar">
      ...
      <search-input ref="searchInput" :keyword.sync="keyword.keyword.value" @search="search" placeholder="plate"
                    width="30%"/>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'plate.sort', prop: 'sort', width: '60', type: 'text' },
        { name: 'plate.name', prop: 'name', width: '160', type: 'text' },
        { name: 'plate.letter', prop: 'letter', width: '160', type: 'text' },
