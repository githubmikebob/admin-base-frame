...
<!--      <open-button @open="vm._dialog.open(vm)"/>-->
      ...
      <search-input ref="searchInput" :keyword.sync="keyword.keyword.value" @search="search" placeholder="user"
                    width="30%"/>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'users.username', prop: 'name', width: '160', type: 'text' },
        { name: 'users.mobile', prop: 'mobile', width: '180', type: 'text' },
        { name: 'users.identity', prop: 'identity', width: '180', type: 'text' },
        { name: 'users.salary', prop: 'salary', width: '180', type: 'price' },
        { name: 'users.created_at', prop: 'created_at', width: '140', type: 'text' },
        { name: 'users.leaved_at', prop: 'leaved_at', width: '140', type: 'text' },
