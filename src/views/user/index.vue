  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'users.nickname', prop: 'nickname', width: '160', type: 'text' },
        { name: 'users.username', prop: 'users.username', width: '160', type: 'text' },
        { name: 'users.mobile', prop: 'mobile', width: '180', type: 'text' },
        { name: 'users.email', prop: 'email', width: '', type: 'text' },
