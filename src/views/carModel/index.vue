<template>
  <div>
    <div class="tool-bar">
      ...
      <search-input ref="searchInput" :keyword.sync="keyword.keyword.value" @search="search" placeholder="carModel"
                    width="30%"/>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'carModel.name', prop: 'name', width: '', type: 'text' },
