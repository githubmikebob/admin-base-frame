<template>
  <div>
    <div class="tool-bar">
      ...
      <search-input ref="searchInput" :keyword.sync="keyword.keyword.value" @search="search" placeholder="carBrand"
                    width="30%"/>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'carBrand.letter', prop: 'letter', width: '100', type: 'text' },
        { name: 'carBrand.name', prop: 'name', width: '', type: 'text' },
